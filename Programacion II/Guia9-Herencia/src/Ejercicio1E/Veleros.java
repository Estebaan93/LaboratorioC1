...
fabricación. Sin embargo, se pretende diferenciar la información de algunos tipos de barcos especiales:
...
public class Veleros extends Barco {
    ...
    // Número de mástiles para veleros.
    private int numMastiles=3;

    //Constructor
    public Veleros() {
    }
    public Veleros(int numMastiles, String matricula, double eslora, int anioFabricacion) {
        super(matricula, eslora, anioFabricacion);
        this.numMastiles = numMastiles;
        this.valorModulo=this.valorModulo+numMastiles;                                  //Valor de eslora+dia+numMastiles
    }
    ...
    public String toString() {
        return "Veleros{" + "numMastiles=" + numMastiles + super.toString()+'}';
    }
