/*Un Barco se caracteriza por: su matrícula, su eslora en metros y año de fabricación. Sin embargo, se pretende diferenciar la información 
de algunos tipos de barcos especiales:
...
public class YatesLujo extends Barco{
    // Potencia en CV y número de camarotes para yates de lujo.
    private double potencia=60;
    private int numCamarotes=9;
    
    
    //Constructor
    public YatesLujo() {
    }    
    public YatesLujo(double potencia, int numCamarotes, String matricula, double eslora, int anioFabricacion) {
        super(matricula, eslora, anioFabricacion);
        this.potencia = potencia;
        this.numCamarotes = numCamarotes;
        this.valorModulo=this.valorModulo+potencia+numCamarotes;                        //Valor de eslora+dia+potencia+numeroCamarotes
    }
    ...
    public String toString() {
        return "YatesLujo{" + "potencia=" + potencia + ", numCamarotes=" + numCamarotes + super.toString()+ '}';
    }
