/*Un Barco se caracteriza por: su matrícula, su eslora en metros y año de fabricación. Sin embargo, se pretende diferenciar la información de algunos 
...
public class Barco {
   // public static Scanner leer=new Scanner(System.in).useDelimiter("\n");
    ...
    protected double eslora, valorModulo;
    ...
    public Barco(String matricula, double eslora, int anioFabricacion) {
        ...
        this.valorModulo=eslora*10;                                 //Eslora= largo*10
    }
